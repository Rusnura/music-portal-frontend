...
Получить свои альбомы
-
Если необходимо получить список своих альбомов, необходимо послать запрос:
...
Ответ: JSON с массивом аудиозаписей пользователя из выбранного альбома.
JSON представление ответа:
...
-
Есть возможность получить все свои аудиозаписи из разных альбомов.
Чтобы сделать это - необходимо послать GET запрос:

    GET			/api/songs

Ответ: JSON с массивом аудиозаписей пользователя из всех альбомов.
JSON представление ответа:
